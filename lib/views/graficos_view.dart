      ...
      children: [
        ...
        Expanded(
          child: totaisPorCategoria.isEmpty
              ? Center(
                  child: Text('Sem registros para exibir.',
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          String nome =
                              totaisPorCategoria.keys.elementAt(index);
  ...
  Widget _buildDateSelector() {
    return InkWell(
      ...
      child: Column(
        ...
        children: [
          Text('${widget.dataSelecionada.year}',
              style: TextStyle(
                  color: Colors.white.withValues(alpha: 0.8), fontSize: 12)),
          Row(
            children: [
              Text(_meses[widget.dataSelecionada.month - 1],
                  style: const TextStyle(
                      color: Colors.white,
                      fontSize: 18,
                      fontWeight: FontWeight.bold)),
